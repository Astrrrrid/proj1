...
class Course(db.Model):
    ...
    session_ID = db.Column(db.String(32), index = True, unique = True)# then migrate, add a new col in spreadsheet, check the existing code read the xl function, check update(match code+seesionID
